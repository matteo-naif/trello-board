...
export const TimeConverter = () => {
  ...
  return (
    <div
      className={
        "fixed block top-2 transition-transform right-0 z-10" +
        (!isVisible && " translate-x-96")
      }
    >
      <div className="flex gap-0 items-center">
        <button
          className="w-12 h-12 bg-gray-900 rounded-l-3xl flex items-center justify-center"
        ...
        <div className="bg-gray-900 p-6 rounded-l-3xl w-96">
          ...
          <p className="text-white mt-6">
            {timeDecimal.toFixed(2).replace(".", ",")} ore
          </p>
        </div>
      </div>
    </div>
